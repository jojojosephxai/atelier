/**
 * Guest side of the parent ↔ sandbox preview postMessage bridge.
 *
...
export const PREVIEW_BRIDGE_CHANNEL = "atelier-preview-bridge" as const;
...
export function installPreviewHostBridge(
  ...
  const ROOT_STATE_KEY = "__atelierPreviewBridgeRoot";
