 ...
 *
 * Each app federates to the shared **auth broker** (`ATELIER_AUTH_ISSUER`), which
 ...
 * here (`{ providerId: "atelier-github", idp: "github", label: "GitHub" }`). The
...
export const ATELIER_AUTH_PROVIDERS: readonly AuthProviderConfig[] = [
  { providerId: "atelier-google", idp: "google", label: "Google" },
  { providerId: "atelier-x", idp: "twitter", label: "X" },
];
