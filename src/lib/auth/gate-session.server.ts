...
export const GATE_PROVIDER_ID = "atelier-gate";
const GATE_ACCOUNT_ISSUER = "https://example.invalid";
...
/**
 * Clear a stale marker when a `/get-session` arrives without `x-atelier-identity`:
