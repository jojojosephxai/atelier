 ...
 *
 *   node scripts/write-atomic.mjs /workspace/.atelier/og.jpg.tmp public/og.jpg
 *
 ...
 * /workspace/.atelier/" contract rests on — cannot be provoked portably.
 */
    ...
    if (err?.code === "EXDEV") {
      throw new Error(
        `${staged} is on another filesystem than ${target}, so the hand-over cannot be a `
          + "rename — stage under /workspace/.atelier/ instead",
      );
    }
    throw err;
  }
